...
,FORMAT_DATE('%b', trip_start_date) as trip_start_date_month_name
,extract(month from trip_start_date) as trip_start_date_month
,company
,payment_type
...
group by 1,2,3,4,5 order by 1 desc, 3 asc,6 desc
